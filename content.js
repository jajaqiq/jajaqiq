...
const portfolio = {
  ...
  skills: ["Python", "Requests", "Beautiful Soup", "DrissionPage", "Pandas"],
  projects: [
    ...
    { category: "crawler", number: "07", title: "云音乐", description: "爬虫采集到的音乐制作的仿网易云风格在线音乐播放器，支持歌单切换、播放控制、进度拖拽与歌词展示。", tags: ["JavaScript", "Audio API", "UI Design"], link: "Portfolio/云音乐网站.html", accent: "blue", bgImage: "Portfolio/bgimgs/开阳云音乐.png" },
    ...
    { category: "creative", number: "18", title: "炫酷项目展示", description: "AI编程等。", tags: ["AIGC", "提示词","python"], link: "Portfolio/炫酷项目展示.html", accent: "coral", bgImage: "Portfolio/bgimgs/AIGC.png"},
    ]
};
